...
class RRTStar:
    ...
    def __init__(self, start, goal, obstacle_list, rand_area, expand_dis, path_resolution, goal_sample_rate, max_iter):
    ...
    def rewire(self, new_node, near_inds):
        for i in near_inds:
            ...
            improved_cost = new_node.cost + self.calc_distance_and_angle(new_node, near_node)[0] < near_node.cost
            if no_collision and improved_cost:
                near_node.parent = new_node
                near_node.cost = new_node.cost + self.calc_distance_and_angle(new_node, near_node)[0]
