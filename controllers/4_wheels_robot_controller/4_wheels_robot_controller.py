...
class FourWheeledRobot:
    def __init__(self, time_step):
        ...
        self.four_wheels_robot = self.robot.getFromDef("FourWheelsRobot")
        self.rotation_field = self.four_wheels_robot.getField("rotation")
        self.wheels = []
    ...
    def get_position(self):
        robot_pos = self.four_wheels_robot.getPosition()
    ...
    def get_velocity(self):
        velocity = self.four_wheels_robot.getVelocity()
    ...
    def step(self):
        ...
        if self.current_target_index < len(self.path):
            ...
            left_speed = self.limit_speed(linear_velocity - angular_velocity, -10, 10)
            right_speed = self.limit_speed(linear_velocity + angular_velocity, -10, 10)
...
TIME_STEP = 64
robot_controller = FourWheeledRobot(TIME_STEP)
